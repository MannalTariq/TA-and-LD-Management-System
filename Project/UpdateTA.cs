...
namespace Project
{
    public partial class UpdateTA : Form
    {
        ...
        private void UpdateTA_Load(object sender, EventArgs e)
        {
        ...
        private void UpdateTA_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE Teacher_Assistant SET FName = '" + FName + "', LName = '" + LName + "', Email = '" + mail + "', Phone = '" + contact + "', Pasword = '" + pass + "', dob = '" + dob + "' WHERE username = '" + uname + "'";
