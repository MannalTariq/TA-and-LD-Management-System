...
namespace Project
{
    public partial class CourseInstructorSections : Form
    {

        public string TableUser { get; set; }
        public int C_ID { get; set; }
        public CourseInstructorSections()
        {
            InitializeComponent();
        }

        private void CourseInstructorSections_Load(object sender, EventArgs e)
        {
            LoadCIntDetails();
        ...
        public void LoadCIntDetails()
        {
            ...
            string query = " exec CTSections " + C_ID;
