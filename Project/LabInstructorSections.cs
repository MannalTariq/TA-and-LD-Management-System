...
namespace Project
{
    public partial class LabInstructorSections : Form
    {
        public string TableUser { get; set; }
        public int L_ID { get; set; }
        public LabInstructorSections()
        {
            InitializeComponent();
        }

        private void LabInstructorSections_Load(object sender, EventArgs e)
        {
            LoadCIntDetails();
        ...
        public void LoadCIntDetails()
        {
            ...
            string query = " exec LTSections " + L_ID;
        ...
        private void backfromltsec_Click(object sender, EventArgs e)
        {
